...
export class BotGroup {
  ...
  static createBot<T extends BotClassName>(
    name: T,
    params: any
  ): InstanceType<typeof botClassMap[T]>;
  static createBot(
    name: BotClassName,
    params: any
  ): InstanceType<typeof botClassMap[BotClassName]> {
    return plainToInstance(
      botClassMap[name] as any,
      params
    ) as unknown as InstanceType<typeof botClassMap[BotClassName]>;
  }
}
